...
| P1 CUDA Fundamentals | [hands-on/p1-cuda/](hands-on/p1-cuda/) | CUDA execution model, indexing, first kernel, vector add, memory access patterns, shared memory, error checking, timing — with notes, 1 CPU simulator, and 9 CUDA examples |
