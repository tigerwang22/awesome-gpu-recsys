...
| P1 CUDA Fundamentals | [hands-on/p1-cuda/](hands-on/p1-cuda/) | CUDA execution model, thread/block/grid indexing, first kernel, vector add — with notes, 1 CPU simulator, and 3 CUDA examples |
